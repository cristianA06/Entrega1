...
@NamedQueries({
    ...
    , @NamedQuery(name = "Logintable.findById", query = "SELECT l FROM Logintable l WHERE l.id = :id")
    , @NamedQuery(name = "Logintable.findByUsuario", query = "SELECT l FROM Logintable l WHERE l.usuario = :usuario")
...
public class Logintable implements Serializable {
    ...
    public Logintable(Integer id) {
        this.id = id;
    }

    public Logintable(Integer id, String usuario, String password) {
        this.id = id;
    ...
    public String toString() {
        return "udem.edu.co.entities.Logintable[ id=" + id + " ]";
    }
